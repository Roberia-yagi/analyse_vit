...
def _load_model(
    ...
    # ローカル配置・パッケージ配置の双方に対応
    try:
        from .pe import load_pe_model
        from .qwen3_vl_embedding import load_qwen3_vl_embedding_model
        from .siglip2 import load_siglip2_model
    except Exception:
        from pe import load_pe_model  # type: ignore
        from qwen3_vl_embedding import load_qwen3_vl_embedding_model  # type: ignore
        from siglip2 import load_siglip2_model  # type: ignore
